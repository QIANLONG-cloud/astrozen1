  ...
  projects: [
    {
      ...
      linkPreview: "https://robohorizon.cn/zh/videos/wuji-hand-2-senses-torque-directly-through-its-motors/",
      linkSource: "https://www.wuji.tech/zh/",
      image: "/wuji-hand.jpg",
    },
    {
      name: "无框力矩电机 G/F 系列",
      ...
      linkPreview: "https://vvbwj1rjubu.feishu.cn/file/XuODbm3sGosXeKxcU73ciIsknag",
      linkSource: "https://www.wuji.tech/zh",
      image: "/motor.jpg",
    },
    {
      ...
      linkPreview: "https://www.raetts.com/pro",
      linkSource: "https://www.raetts.com/about",
      image: "/fan.jpg",
    },
    {
      ...
      linkPreview: "https://www.apple.com.cn/imac/",
      linkSource: "https://www.apple.com.cn/store",
      image: "/imac.jpg",
    },
  ],
  "about": {
    description:
      "你好，我是刘钱龙，10 年质量工程经验，现任深圳舞肌科技 DQE / 项目质量负责人（QPL），主导 Wuji Hand 灵巧手 1 代、2 代产品研发项目质量管理。我的职业生涯起步于赫比（精密模具），历经富士康（Apple iMac NPI 测量）、雷茨智能（无框力矩电机 / 风机）、到现在的舞肌科技（具身智能灵巧手），覆盖精密模具 / 3C 制造 / 智能装备 / 具身智能 4 个行业。兼具质量工程深度与数字化平台建设能力。累计推动 800+ BUG、100+ 风险闭环。求职意向：质量经理 / QPM / DQE，期望城市：深圳。",
    image: "/about.jpg",
  },
};